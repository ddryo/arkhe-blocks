 ...
 *
 *
 * https://github.com/inc2734/snow-monkey-blocks/blob/master/block/panels/item/vertical/edit.js
 *
 * Figure:
 * https://github.com/inc2734/snow-monkey-blocks/blob/master/src/js/component/figure.js
 *
 */
...
import { PanelBody, BaseControl, Button, Popover, Toolbar } from '@wordpress/components';
					...
					>
						<div className='smb-list-icon-selector'>
							{times(titleTagNames.length, (index) => {
								...
								const isPrimary = titleTagName === titleTagNames[index];
								return (
									<Button
										isPrimary={isPrimary}
			...
			<BlockWrapper className={classes}>
				<div className='smb-panels__item'>
					...
					<div className='smb-panels__item__body'>
						...
						{(!RichText.isEmpty(linkLabel) || !!linkURL || isSelected) && (
