...
#zプラグインファイルをip化
zip -r arkhe-blocks-pro.zip arkhe-blocks-pro -x "*/.*" "*/__*" "*bin*" "*node_modules*" "*vendor*" "*/src/blocks/*.js" "*/src/components*" "*phpcs.xml" "*gulpfile.js" "*README.md"
