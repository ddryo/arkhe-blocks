...
<div class="ark-block-blogCard c-boxLink">
	<a href="<?=esc_url( $args['url'] )?>" class="c-boxLink__inner" data-type="<?=$args['type']?>"<?=$target . $rel?>>
		...
		<div class="c-boxLink__body">
			...
			<?php if ( $args['caption'] ) : ?>
				<div class="c-boxLink__more">
					<img class="c-boxLink__favicon lazyload" data-src="https://www.google.com/s2/favicons?domain_url=<?=esc_url( $args['url'] )?>" alt="">
